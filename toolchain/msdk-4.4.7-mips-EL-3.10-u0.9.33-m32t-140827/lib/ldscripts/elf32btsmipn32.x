...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("/tmp/msdk-4.4.7-2001/release/msdk-4.4.7/linux/uclibc/mips-linux-uclibc/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
