 ...
 *
 * $Revision: 70732 $
 * $Date: 2016-08-15 10:28:31 +0800 (週一, 15 八月 2016) $
 *
...
rtk_api_ret_t rtk_port_phyComboPortMedia_set(rtk_port_t port, rtk_port_media_t media)
{
    ...
    if(media == PORT_MEDIA_FIBER)
    {
        ...
        if ((retVal = rtl8367c_setAsicReg(RTL8367C_REG_SDS_INDACS_DATA, 0x0000))!=RT_ERR_OK)
            return retVal;

        if ((retVal = rtl8367c_setAsicReg(RTL8367C_REG_SDS_INDACS_ADR, 0x002E))!=RT_ERR_OK)
            return retVal;
