...
int CmdNANDECCGEN(int argc, char* argv[])
{
	...
	unsigned char *dma_addr= strtoul((const char*)(argv[0]), (char **)NULL, 16);
    unsigned char *des_addr = strtoul((const char*)(argv[1]), (char **)NULL, 16);
    unsigned char *p_eccbuf= strtoul((const char*)(argv[2]), (char **)NULL, 16); 
